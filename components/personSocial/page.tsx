        ...
        <div className="relative flex-1">
          ...
          <div className="hidden sm:block">
            <p className="mb-6 text-[18px] font-normal text-[#192451]">
              The true spirit of this center depicts the struggle, commitment
              and intellectual contribution of Dr Arif Naveed in
              reconceptualizing the role of schooling in intergenerational
              social mobility in bringing extremely excluded families out of
              poverty through education. In his path breaking doctoral thesis at
              Cambridge University, Arif explains Pakistan ’s education policy
              failure for poor.
            </p>
            ...
            <div className="font-Italic relative mb-6 max-w-[470px] p-4 text-[14px] leading-[160%] font-normal text-[#192451]">
              ...
              education in favour of the more resource-rich geographies. Those
              who benefitted most are the children of better educated and more
              resourceful parents, and not those experiencing the worst forms of
              deprivation and exclusion. Arif Naveed’s evidence-based
              explanation of education failure since 2010, particularly provides
              exceptional insights into the sociology of education in South Asia
              and redefines the framing of education policy research into the
              issue of strategic schooling.”
            </div>

            <p className="font-Inter mb-6 text-[18px] leading-[160%] font-normal text-[#192451]">
              Arif Naveed’s Programme on Education and Social Mobility will
              solely focus on pushing his vision to use the transformative power
              of education to change the condition of families in extreme
              poverty by promoting research, policy engagement and actual
              engagement programmes for families living in extreme poverty to
              develop needed social capital along with schooling for their
              children as Arif argued to work towards familial social mobility
              route.
            </p>
