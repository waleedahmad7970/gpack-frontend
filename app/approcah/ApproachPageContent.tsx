...
import ApproachThemeSection from '@/components/Sections/ApproachThemeSection';
import ScholarApproachSection from '@/components/Sections/ScholarApproachSection';
...
const ApproachPageContent = () => {
    ...
    return (
        <>
            ...
            <OurApproachSection />
            <ApproachThemeSection />
            <ScholarApproachSection />
            <ScrollingSection />
        </>
    );
};
